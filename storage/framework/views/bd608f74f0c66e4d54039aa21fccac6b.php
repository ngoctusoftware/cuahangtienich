...
<div class="col-lg-3 col-md-4 col-6">
    <div class="product-card">
        <a <?php if($translation): ?> href="<?php echo e(route('products.show', ['slug' => $translation->slug])); ?>" <?php endif; ?> class="product-thumb">
            <img src="<?php echo e($product->thumbnail ? asset('storage/'.$product->thumbnail) : asset('images/product-placeholder.jpg')); ?>"
                 class="img-fluid" alt="<?php echo e($translation?->name); ?>">
        ...
        <div class="product-info">
            <h6 class="product-name">
                <a <?php if($translation): ?> href="<?php echo e(route('products.show', ['slug' => $translation->slug])); ?>" <?php endif; ?>><?php echo e($translation?->name); ?></a>
            </h6>
...
<?php /**PATH /home/ntsoftware/Downloads/www/affiliate.store/resources/views/products/partials/card.blade.php ENDPATH**/ ?>